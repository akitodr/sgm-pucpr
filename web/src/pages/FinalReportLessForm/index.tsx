...
const FinalReportLessForm: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Container>
        <FormContainer>
          <h2>ANEXO 2 – RELATÓRIO FINAL PARA NOTA ANTERIOR INFERIOR A 8,0</h2>
          <p>
            Utilize este Anexo se, ao ser avaliado em ciclo anterior, o
            relatório final obteve nota inferir a 8,0.
          </p>
          <Form
            form={form}
            layout="vertical"
          ...
          >
            ...
            >
              <TextArea
                rows={4}
                placeholder="Explicação do item: descreva aqui as atividades realizadas pelo(s) monitor(es) durante este ciclo de monitorias. Justifique a coerência das atividades com o projeto enviado."
              />
            </Form.Item>

            <Form.Item
              name="reach_of_program"
            ...
            <Form.Item
              name="teacher_autoreflexion"
              label="4.AUTORREFLEXÃO DO PROFESSOR:"
              rules={[{ required: true }]}
            >
              <TextArea
                rows={4}
                placeholder="Explicação do item: apresente aqui a sua análise dos resultados da monitoria deste ciclo e as propostas concretas de melhoria para o próximo ciclo com base na reflexão sobre os dados. Considere ações frente aos insucessos, mas também para fortalecer os pontos positivos."
              />
            </Form.Item>

            <Form.Item
              name="reconduction_option"
              label="5.DESEJA RECONDUZIR ESTE PROJETO PARA O PRÓXIMO CICLO?"
              rules={[{ required: true }]}
            >
              <Radio.Group
            ...
            <Form.Item
              name="project_bond"
              label="5.1 Vinculação do projeto de monitoria:"
              rules={[{ required: true }]}
            >
            ...
            <Form.Item
              name="disciplines_id"
              label="5.2 Informe as disciplinas atendidas pelo projeto em 2020/2, caso haja mudanças com relação ao ciclo anterior."
            >
              <Button
                type="primary"
            ...
            <p>5.3 Modalidade de atendimento do(s) monitor(es):</p>
            <p>
